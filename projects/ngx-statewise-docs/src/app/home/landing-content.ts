...
export const COMPARISON: readonly ComparisonRow[] = [
  {
    axis: { en: 'Where the state lives', fr: 'Où vit l’état' },
    byHand: {
  ...
  {
    axis: { en: 'What starts a change', fr: 'Ce qui déclenche un changement' },
    byHand: {
  ...
  {
    axis: { en: 'The order things run in', fr: 'L’ordre d’exécution' },
    byHand: {
...
export const DOORS: readonly Door[] = [
  {
    title: { en: 'Install it', fr: 'L’installer' },
    text: {
  ...
  {
    title: { en: 'Understand the flow', fr: 'Comprendre le flux' },
    text: {
  ...
  {
    title: { en: 'Read real code', fr: 'Lire du vrai code' },
    text: {
