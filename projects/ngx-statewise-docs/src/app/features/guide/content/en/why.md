...
| What                                                      | Measured           |
| --------------------------------------------------------- | ------------------ |
| the complete `task` flow                                  | 5 files, 532 lines |
| `asReadonly()` lines re-exposing state, across 3 managers | 19                 |
...
dispatched and the path it took, which covers "what happened"; it does not
cover stepping through it.
